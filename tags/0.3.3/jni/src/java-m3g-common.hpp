...
void    bindJavaReference (JNIEnv* env, jobject obj, m3g::Object* pointer);
void    releaseJavaReference (JNIEnv* env, m3g::Object* pointer);
 ...
 * @return 作成したJavaオブジェクトの「ローカル参照」が返る。
